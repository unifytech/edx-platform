...
class CourseSettingsTest(StudioCourseTest):
    ...
    def set_course_dates(self):
        ...
        self.settings_page.set_value(dates_dictionary)
    ...
    def test_user_can_set_course_date(self):
        ...
        self.settings_page.set_value(time_dictionary)
        ...
        self.assertEquals(
            [get_input_value(self.settings_page, css_selector)[0] for css_selector in css_selectors],
            expected_values
        )
    ...
    def test_clear_previously_set_course_dates(self):
        ...
        self.settings_page.set_value(values_to_set)
    ...
    def test_cannot_clear_the_course_start_date(self):
        ...
        default_start_date = get_input_value(self.settings_page, self.COURSE_START_DATE_CSS)[0]
        ...
        self.assertEquals(element_has_text(self.settings_page, error_message_css,
                                           "The course must have an assigned start date."), True)
        # Refresh the page and assert start date has not changed.
        self.settings_page.refresh_and_wait_for_load()
        self.assertEquals(
            get_input_value(self.settings_page, self.COURSE_START_DATE_CSS)[0],
            default_start_date
        )
    ...
    def test_settings_are_only_persisted_when_saved(self):
        ...
        default_value_enrollment_start_date = get_input_value(self.settings_page,
                                                              self.ENROLLMENT_START_TIME_CSS)[0]
